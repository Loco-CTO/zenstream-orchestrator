        ...
        self._database = DatabaseHandler(
            ...
            create_query={
                ...
                """,
                    ...
                    "syncplay_members": {"create": """CREATE TABLE IF NOT EXISTS syncplay_members (group_id TEXT NOT NULL, user_id TEXT NOT NULL, participant_id TEXT NOT NULL DEFAULT '', username TEXT NOT NULL, watching_together INTEGER NOT NULL DEFAULT 1, viewing INTEGER NOT NULL DEFAULT 0, loading INTEGER NOT NULL DEFAULT 0, ready_generation INTEGER NOT NULL DEFAULT -1, presence_sequence INTEGER NOT NULL DEFAULT 0, PRIMARY KEY (group_id, participant_id))""", "columns": {"group_id":"TEXT", "user_id":"TEXT", "participant_id":"TEXT NOT NULL DEFAULT ''", "username":"TEXT", "watching_together":"INTEGER NOT NULL DEFAULT 1", "viewing":"INTEGER NOT NULL DEFAULT 0", "loading":"INTEGER NOT NULL DEFAULT 0", "ready_generation":"INTEGER NOT NULL DEFAULT -1", "presence_sequence":"INTEGER NOT NULL DEFAULT 0"}},
