...
class CredentialsRequest(DocsModel):
    ...
    deviceId: str | None = Field(default=None, examples=["web-demo"])
    authFlow: str | None = Field(default=None, examples=["refresh-v1"])


class RefreshRequest(DocsModel):
...
class SessionResponse(DocsModel):
    ...
    expiresAt: str | None = Field(default=None, json_schema_extra={"readOnly": True})
    sessionId: str | None = Field(default=None, json_schema_extra={"readOnly": True})
    refreshToken: str | None = Field(
        default=None,
        description="Rotating refresh token returned to non-browser clients.",
        json_schema_extra={"readOnly": True, "writeOnly": True},
    )
    refreshExpiresAt: str | None = Field(
...
class BootstrapResponse(DocsModel):
    user: User | None = None
    token: str | None = Field(default=None, json_schema_extra={"readOnly": True})
    expiresAt: str | None = Field(default=None, json_schema_extra={"readOnly": True})
    expiresIn: int | None = Field(default=None)
    sessionId: str | None = Field(default=None, json_schema_extra={"readOnly": True})
    refreshToken: str | None = Field(
        default=None, json_schema_extra={"readOnly": True, "writeOnly": True}
    )
    refreshExpiresAt: str | None = Field(
        default=None, json_schema_extra={"readOnly": True}
    )
...
class PlaylistDetail(DocsModel):
    ...
    isMember: bool | None = Field(
        default=None,
        description="When membershipSourceId is provided, all accessible source tracks are members.",
    )
...
_SUMMARY_OVERRIDES = {
    ...
    (
        "POST",
        "/api/account/playlists/{playlist_id}/items",
    ): "Add catalog items to a playlist",
    (
        "DELETE",
        "/api/account/playlists/{playlist_id}/items/by-source/{source_id}",
    ): "Remove a source's tracks from a playlist",
    (
        "DELETE",
        "/api/account/playlists/{playlist_id}/items/{entry_id}",
    ): "Remove an item from a playlist",
    (
        "PATCH",
        "/api/account/playlists/{playlist_id}/items/{entry_id}/move",
    ): "Move a playlist entry before or after another entry",
